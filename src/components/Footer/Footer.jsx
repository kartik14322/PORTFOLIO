      ...
      <div className="container mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-6">
          {[
            ...
            { icon: <FaLinkedin />, link: "https://www.linkedin.com/in/kartiksahu2211?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
            { icon: <FaInstagram />, link: "https://www.instagram.com/_kartik_14319/" },
            { icon: <SiLeetcode />, link: "https://leetcode.com/u/_kartik_14319/" },
            { icon: <FaGithub />, link: "https://github.com/kartik14322" },
